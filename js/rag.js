...
class VoxEngine {
    ...
    pump() {
        ...
        while (this.pendingReqs.length > 0 && this.pendingReqs[0].isDone)
            this.finishedReqs.push(this.pendingReqs.shift());
