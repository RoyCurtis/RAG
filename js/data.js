var PHRASES = [
    "Platform {PLATFORM} for the {TIME} {SERVICE} service to {STATION}. Calling at" +
    " {STATION_LIST}. This train is formed of {COACHES}.",

    "The train at platform {PLATFORM} is the {TIME} {SERVICE} service to {STATION}." +
    " Calling at {STATION_LIST}. Will passengers intending to travel on this service" +
    " please join the train now, as it is ready to leave. Platform {PLATFORM} for the" +
    " {TIME} {SERVICE} service to {STATION}, which is ready to leave.",

    "We are sorry to announce that the {TIME} {SERVICE} service to {STATION}, is" +
    " delayed by approximately {MINUTES} minutes due to {EXCUSE} at {STATION2}.{DELAY}",

    "Please do not leave your personal belongings unattended on the station. Any" +
    " personal belongings left unattended may be removed without warning, or destroyed" +
    " or damaged by the security services.",

    "24 hour C.C.T.V. recording is in operation at this station for the purpose of" +
    " security and safety.",
